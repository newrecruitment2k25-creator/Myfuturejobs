      ...
      <main style={{ maxWidth:900, margin:'0 auto', padding:'32px 16px', display:'flex', flexDirection:'column', gap:24 }}>
        ...
        <div className="rounded-2xl border border-border bg-card p-6 shadow-sm">
          <div className="flex flex-wrap items-start justify-between gap-4">
            <div>
              <p className="text-xs font-semibold uppercase tracking-wider text-muted-foreground">Candidate Assessment</p>
              <h1 className="mt-1 text-3xl font-bold tracking-tight text-primary">{candidate.candidateName}</h1>
              <p className="text-sm text-muted-foreground mt-1">{candidate.targetRole} · {candidate.industry} · {candidate.experienceLevel}</p>
            </div>
            <div className="flex flex-col items-end gap-2">
              <p className="text-5xl font-extrabold text-primary tabular-nums">{candidate.overallMatchScore}%</p>
