...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "PerksoPrax AI — Caseworker Intelligence Platform" },
      ...
      { name: "author", content: "PerksoPrax AI · PERKESO" },
      { property: "og:title", content: "PerksoPrax AI — Caseworker Intelligence Platform" },
      ...
      { name: "twitter:title", content: "PerksoPrax AI — Caseworker Intelligence Platform" },
      { name: "twitter:description", content: "Caseworker Intelligence Platform for Malaysia's workforce. A PERKESO initiative." },
