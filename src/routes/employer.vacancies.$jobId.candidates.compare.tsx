    ...
    <div style={{ minHeight:'100vh', background:'var(--base)' }}>
      <main style={{ maxWidth:1100, margin:'0 auto', padding:'32px 16px', display:'flex', flexDirection:'column', gap:24 }}>
        ...
        <div className="rounded-2xl border border-border bg-card p-6 shadow-sm">
          <p className="text-xs font-semibold uppercase tracking-wider text-muted-foreground">Candidate Comparison</p>
          <h1 className="mt-1 text-3xl font-bold tracking-tight text-primary">Side-by-Side Assessment</h1>
          <p className="text-sm text-muted-foreground mt-1">Comparing {candidates.length} candidates for {vacancyTitle}</p>
        </div>
