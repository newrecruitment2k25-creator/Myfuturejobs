...
export const Route = createFileRoute("/privacy")({
  ...
  head: () => ({
    meta: [
      { title: "Privacy Policy — PerksoPrax AI" },
      { name: "description", content: "How PerksoPrax AI collects, uses, and protects your personal information." },
    ],
  }),
});

const PRIVACY_SECTIONS = [
  { id: "intro",    num: "01", title: "Introduction",        body: `Welcome to PerksoPrax AI, a PERKESO Initiative. We are committed to protecting and respecting your privacy. This Privacy Policy explains how we collect, use, and safeguard your personal information in accordance with the Personal Data Protection Act 2010 (PDPA) of Malaysia.\n\nBy using the PerksoPrax AI platform, you consent to the data practices described in this statement. We ensure that your career journey is supported by secure, ethical data handling practices designed to maximise your employability while maintaining absolute digital sovereignty over your personal information.` },
  ...
  { id: "ai",       num: "04", title: "AI Processing", body: `PerksoPrax AI leverages the PerksoPrax AI Engine to provide precision career matching and resume optimisation.\n\nAnonymised Synthesis: Your data is stripped of direct identifiers before being processed for skill-gap analysis and job recommendations.\n\nNo Training Usage: We do not use your private personal data to train public AI models. Your data remains within the PerksoPrax AI secure perimeter.\n\nAI-generated insights are designed to assist, not replace, human judgment in the recruitment process.` },
  ...
  { id: "rights",   num: "07", title: "Your Rights",          body: `You have the right to:\n• Access your personal data\n• Correct inaccuracies\n• Request data deletion\n• Withdraw consent\n\nContact our Data Protection Officer at dpo@PerksoPrax AI.gov.my to exercise these rights.` },
        ...
        <div style={{ display: "grid", gridTemplateColumns: "220px 1fr", gap: 32, alignItems: "start" }} className="privacy-grid">
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
            ...
            <p style={{ fontSize: 12, color: "var(--muted)", textAlign: "center", padding: "8px 0 0" }}>
              {t("privacyFooter")}<br />© 2024–2026 PerksoPrax AI Platform
            </p>
          </div>
        </div>
      </div>
