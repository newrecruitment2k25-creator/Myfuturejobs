...
const PRIVACY_SECTIONS = [
  ...
  { id: "use",      num: "03", title: "How We Use Data",     body: `We use your information to provide and improve our services, match jobseekers with relevant opportunities, enable AI-powered CV analysis and career guidance, communicate with you, and comply with legal obligations. We may also use anonymised data for research and platform improvements.` },
