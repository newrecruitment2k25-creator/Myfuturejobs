      ...
      <main className="mx-auto max-w-5xl px-4 py-10 sm:px-6 space-y-6">
        ...
        <div className="rounded-2xl border border-border bg-card p-6 shadow-sm">
          <div className="flex flex-wrap items-start justify-between gap-4">
            <div>
              <p className="text-xs font-semibold uppercase tracking-wider text-muted-foreground">Admin - Audit</p>
              <h1 className="mt-1 text-2xl font-bold tracking-tight text-primary">Audit Logs</h1>
              <p className="mt-1 text-sm text-muted-foreground">All system actions recorded from admin operations.</p>
            </div>
